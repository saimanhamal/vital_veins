  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (errorLower.includes('pending') || errorLower.includes('admin approval')) {
          setErrors({
            submit: '⏳ Your account is pending admin approval. You will receive an email once approved. Thank you for your patience!'
          });
        } else if (errorLower.includes('under verification')) {
          setErrors({
